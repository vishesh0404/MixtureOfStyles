...
public class DashbordDanceStyleListAdapter extends RecyclerView.Adapter<DashbordDanceStyleListAdapter.MyViewHolder>{
    Context context;
    private List<DashbordDanceStyleList> styleLists;
    public DashbordDanceStyleListAdapter(Context applicationContext, List<DashbordDanceStyleList> styleLists) {
        this.context = applicationContext;
        this.styleLists = styleLists;
    }
    @NonNull
    @Override
    public DashbordDanceStyleListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
    ...
    @Override
    public void onBindViewHolder(@NonNull DashbordDanceStyleListAdapter.MyViewHolder holder, int position) {
