...
public class InstructorVideoListAdapter extends RecyclerView.Adapter<InstructorVideoListAdapter.MyViewHolder> implements Filterable {
    Context context;
    private List<DanceStyleList> styleLists;
    private List<DanceStyleList> styleListsFilter;
    public InstructorVideoListAdapter(Context applicationContext, List<DanceStyleList> styleLists) {
