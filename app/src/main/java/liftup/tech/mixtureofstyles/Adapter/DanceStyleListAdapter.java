...
public class DanceStyleListAdapter extends RecyclerView.Adapter<DanceStyleListAdapter.MyViewHolder> implements Filterable {
    Context context;
    private List<DanceStyleList> styleLists;
    private List<DanceStyleList> styleListsFilter;
    public DanceStyleListAdapter(Context applicationContext, List<DanceStyleList> styleLists) {
    ...
    @NonNull
    @Override
    public DanceStyleListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
    ...
    @Override
    public void onBindViewHolder(@NonNull DanceStyleListAdapter.MyViewHolder holder, int position) {
