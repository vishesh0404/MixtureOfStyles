...
public class InstructorsCategoryListAdapter extends RecyclerView.Adapter<InstructorsCategoryListAdapter.MyViewHolder>{
    Context context;
    ...
    public InstructorsCategoryListAdapter(Context applicationContext, List<ShowcaseCategoryList> categoryLists, OnItemSelectedLister onItemSelectedLister) {
    ...
    @NonNull
    @Override
    public InstructorsCategoryListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
    ...
    @Override
    public void onBindViewHolder(@NonNull InstructorsCategoryListAdapter.MyViewHolder holder, int position) {
