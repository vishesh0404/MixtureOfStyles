...
public class DashbordStudentShowcaseLisAdapter extends RecyclerView.Adapter<DashbordStudentShowcaseLisAdapter.MyViewHolder>{
    Context context;
    private List<DashbordStudentShowcaseList> styleLists;
    public DashbordStudentShowcaseLisAdapter(Context applicationContext, List<DashbordStudentShowcaseList> styleLists) {
        this.context = applicationContext;
        this.styleLists = styleLists;
    }
    @NonNull
    @Override
    public DashbordStudentShowcaseLisAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
    ...
    @Override
    public void onBindViewHolder(@NonNull DashbordStudentShowcaseLisAdapter.MyViewHolder holder, int position) {
